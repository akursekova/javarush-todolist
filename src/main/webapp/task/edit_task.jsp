...
<%--        <% TaskDTO currentTask = (TaskDTO) request.getAttribute("task"); %>--%>
        <div class="mb-3">
...
<%--                   value=${task.getTitle()}--%>
        ...
        <div class="mb-3">
            ...
            <textarea
                    ...
                    rows="3"><c:out value='${task.description}' />
<%--                ${task.getDescription()}--%>
...
<%--                            ${task.getStatus()}--%>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="taskHours" name="taskHours" value="<c:out value='${task.hours}' />"
<%--                   value=${task.getHours()}--%>

            <%--                    value=<%=currentTask.getHours()%>--%>
        ...
        <div class="input-group">
            ...
            <textarea class="form-control" name="taskText" aria-label="With textarea"><c:out value='${task.text}' />
<%--                ${task.getText()}--%>
                <%--                <%=currentTask.getText()%>--%>
            </textarea>
